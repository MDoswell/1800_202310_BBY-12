  ...
  db.collection(collection)
    ...
    .then((allUsers) => {
      ...
      for (var i = leaderLimit - 10; i < leaderLimit; i++) {
        ...
        newcard.querySelector(".numHazards").innerHTML =
          "Number of Hazards reported: " + numHazards; //Example: NV01.jpg
        newcard.querySelector(".numHelpful").innerHTML =
          "Number of Helpful reviews given: " + numHelpful;
        if (pfp != "") {
...
function populateLeaderboard() {
  let leaderboardCardTemplate = document.getElementById(
    "leaderboardCardTemplate"
  );
